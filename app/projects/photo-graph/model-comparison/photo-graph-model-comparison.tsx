    ...
    >
      <div className="grid gap-8 border-t border-ink py-8 lg:grid-cols-12 lg:gap-6">
        ...
        <div className="lg:col-span-4">
          <h2
            ...
            className="max-w-xl font-display text-4xl leading-[0.95] font-medium tracking-normal sm:text-5xl"
          >
        ...
        <div className="grid gap-5 text-sm leading-6 lg:col-span-6 lg:grid-cols-2">
          <p>
            ...
            the work: moving from one photograph to another through light, tone,
            and palette.
          </p>
          <p>
      ...
      <section className="py-8" aria-labelledby="comparison-heading">
        <div className="mb-5 flex flex-wrap items-end justify-between gap-4">
          ...
          <p className="max-w-xl text-xs leading-5 opacity-60">
            ...
            four results judged relevant; pair agreement measures how closely a
            model follows the reviewed ranking. Unmarked results are unjudged,
        ...
        <div className="grid gap-px bg-ink sm:grid-cols-2 xl:grid-cols-5">
          {report.models.map((model, modelIndex) => {
            ...
            return (
              <article key={model.id} className="min-w-0 bg-canvas p-3">
                <header className="flex min-h-16 items-start justify-between gap-3">
                  ...
                  {isHighestPrecision && (
                    <span className="border border-ink px-1.5 py-1 text-[0.5625rem] leading-none font-semibold tracking-[0.12em] uppercase">
                      Best reviewed P@4
                    </span>
                  )}
                </header>

                <div className="relative mt-2 aspect-4/3 overflow-hidden bg-surface">
                  {/* eslint-disable-next-line @next/next/no-img-element -- Supabase render URLs are already transformed for this comparison tool. */}
                  <img
                  ...
                  />
                  <span className="absolute bottom-0 left-0 bg-ink px-2 py-1 text-[0.625rem] font-semibold tracking-[0.14em] text-canvas uppercase">
                    ...
                    <li key={neighbor.id} className="bg-canvas">
                      <figure className="relative aspect-square overflow-hidden bg-surface">
                        ...
                        <img
                          ...
                          className="size-full object-cover"
                        />
                        <figcaption className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-2 bg-canvas/90 px-1.5 py-1 text-[0.625rem]">
                        ...
                        {neighbor.judgedRelevant && (
                          <span className="absolute top-0 right-0 bg-ink px-1.5 py-1 text-[0.5rem] font-semibold tracking-widest text-canvas uppercase">
                            Relevant
                          </span>
                        )}
                      </figure>
                ...
                <dl className="mt-3 grid grid-cols-2 gap-x-3 gap-y-2 border-t border-ink pt-3 text-xs">
                  ...
                  <div>
                    ...
                    <dd className="mt-0.5 tabular-nums">
                      {model.metrics.edgeCount} edges /{" "}
                      {model.metrics.components} component
      ...
      >
        ...
        <p className="md:text-right">
          Exact all-pairs benchmark /{" "}
          {report.models[0]?.metrics.pairCount.toLocaleString("en-GB")} pairs /
          generated {formatBenchmarkDate(report.generatedAt)}
        </p>
      </section>
        ...
        <div className="grid gap-8 lg:grid-cols-12 lg:gap-6">
          ...
          <div className="max-w-2xl text-sm leading-6 lg:col-span-6">
            <p>
              ...
              deliberately different reference images before anyone is asked to
              browse it.
            </p>
          </div>
        </div>
